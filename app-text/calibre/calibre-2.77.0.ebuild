...
src_install() {
	...
	mv "${HOME}"/.local/share/icons/* "${ED}"usr/share/icons/ #|| die "failed to install icon files"

	domenu "${HOME}"/.local/share/applications/*.desktop #|| die "failed to install .desktop menu files"
